package com.example.afterservice.Aop;
...
public class OperLogAspect {
     ...
     */
    @Pointcut("@annotation(com.example.afterservice.Aop.OperLog)")
     ...
     */
    @Pointcut("execution(* com.example.afterservice.controller..*.*(..))")
    ...
    public void saveOperLog(JoinPoint joinPoint, Object keys) {
        ...
        try {
            ...
            operlog.setOperUserId(JWTUtil.getIdByheader(request)); // 请求用户ID
            operlog.setOperUserName(JWTUtil.getNameByheader(request)); // 请求用户名称
            operlog.setOperIp(CommonUtils.getIpAddrByRequest(request)); // 请求IP
